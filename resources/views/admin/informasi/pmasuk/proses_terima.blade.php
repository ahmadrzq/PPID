...
<section class="section">
    ...
    <div class="section-body">
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('diterima', $permohonan->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-success col-12" disabled>Keputusan PPID Dpenuhi</button>
                        </div>
                        <div class="form-group">
